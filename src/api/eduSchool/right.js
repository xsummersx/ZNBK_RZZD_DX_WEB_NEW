 ...
 * @LastEditTime: 2022-03-14 13:37:45
...
//认知成绩分布-学校
export function GetDisDetailSchool(data) {
  return request({
    url: "/api/DirectorRZZD/GetAreaSchoolIndexDistributeDetailInfo_V3",
    method: "GET",
    params: { ...data },
  });
}
//认知成绩分布-学生
export function GetDisDetailStudent(data) {
  return request({
    url: "/api/DirectorRZZD/GetAreaStuIndexDistributeDetailInfo_V3",
    method: "GET",
    params: { ...data },
  });
}
//认知成绩分布-学校
export function GetDisDetailClass(data) {
  return request({
    url: "/api/GradeLeaderRZZD/GetGradeClassIndexDistributeDetailInfo_V3",
    method: "GET",
    params: { ...data },
  });
}
//认知成绩分布-学生
export function GetDisDetailStudent2(data) {
  return request({
    url: "/api/GradeLeaderRZZD/GetGradeStuIndexDistributeDetailInfo_V3",
    method: "GET",
    params: { ...data },
  });
}
