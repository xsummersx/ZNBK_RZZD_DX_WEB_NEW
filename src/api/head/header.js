 ...
 * @LastEditTime: 2022-01-10 09:26:35
...
// 知识点域
export function GetStuKnowledgeSpectrum(data){
    return request({
        url:"/api/RZZD/GetStuKnowledgeSpectrum",
        method:"GET",
        params:{
            ...data
        }
...
// 知识点域
export function GetCommonKnowledgeSpectrum(data){
    return request({
        url:"/api/RZZD/GetCommonKnowledgeSpectrum",
        method:"GET",
        params:{
            ...data
        }
