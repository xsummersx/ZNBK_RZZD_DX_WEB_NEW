  ...
  <div class="schoolReportBack">
    ...
    <div class="clearfix" style="height: 60px">
      ...
      <div class="rightInfo float-r">
        ...
        ></div> -->
        <img class="teacherHead" :src="resInfo2.PhotoPath" @click="toUserInfo()" alt="" />
...
.schoolReportBack {
  ...
  .rightInfo {
    ...
    .exitIcon:hover {
      background: url("../assets/img/head/exitIcon_h.png") center center no-repeat;
    }
    .teacherName {
      margin: 0 0 0 0;
      color: #fff;
    ...
    .gradeLeader {
      ...
      margin: 0 5px;
      height: 16px;
      background: url("../assets/img/head/schoolLeaderIcon.png") center center no-repeat;
      vertical-align: middle;
    }
    .gradeLeader {
      background: url("../assets/img/head/gradeLeaderIcon.png") center center no-repeat;
    }
    .eduIcon {
      width: 76px;
      margin: 0 5px;
    ...
    .teacherIcon {
      ...
      margin: 0 5px;
      height: 16px;
      background: url("../assets/img/head/teacherIcon.png") center center no-repeat;
      vertical-align: middle;
    }
    .teacherHead {
      width: 28px;
