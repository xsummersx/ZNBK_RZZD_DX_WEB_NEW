 ...
 * @LastEditTime: 2022-03-24 10:25:08
...
<template>
  <div class="bottom-box">
    <div v-show="showList.length > 0" class="clearfix">
      <div @click="GetExportGradePaperQtypeClassCompareList_V3()" class="exportBtn float-r">
    ...
    >
      ...
      <vuescroll
        class="v-scroll"
        :ops="ops"
        style="display: inline-block; width: calc(100% - 232px)"
      >
