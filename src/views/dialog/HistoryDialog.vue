    ...
    <div class="bottomBox">
      <div class="firstLine">
        <div style="height: 18px">
          ...
          >份试卷，系统生成如下对比分析表:<span class="refreshContent" @click="refresh()">
      ...
      <div class="table" :style="{ height: getHeight(SelectedPaperList.length) }" v-if="showTable">
        <div class="ttable" style="display: inline-block; border: 0; vertical-align: top">
          <table>
            <thead>
              <tr>
                <th>序号</th>
            ...
            <tbody>
              <tr v-for="item in SelectedPaperList" :key="item.PaperID">
                ...
                <td v-for="item2 in item.SubjectiveQTypeList" :key="item2.QTypeName">
                  {{ item2.QTypeAvgScore == "/" ? "/" : Number(item2.QTypeAvgScore).toFixed(1) }}
                </td>
