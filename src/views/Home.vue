      ...
      ></video> -->
			<div class="Second-content">
				<div
					...
					:class="{
						AnimationTop:
							$route.name == 'educationRZZD' || $route.name == 'schoolRZZD',
					}"
				>
					...
					<div class="float-r rightHead">
						...
						<div class="RZZDName" v-if="$route.name !== 'studentRZZD'">
							<i
								...
								:class="
									$route.name == 'gradeRZZD' ? 'scholIcon' : 'checkClassIcon'
								"
							></i>
							<span
								v-if="$route.name == 'gradeRZZD'"
