 ...
 * @LastEditTime: 2021-12-24 16:38:39
...
.backRepeat {
  min-width: 1920px;
  background: url("../src/assets/img/head/MainBack.png") center center no-repeat,
    url("../src/assets/img/head/背景右1.png") center center repeat;
}
.eduBack {
  min-width: 1920px;
