 ...
 * @LastEditTime: 2022-03-16 15:56:40
...
<template>
  <div class="right-small-box">
    <div class="box-title clearfix">
      ...
      <span class="float-r check-icon" @click="toDiagnosis"><i></i>薄弱语法诊断</span>
    </div>
    <div class="main" v-show="isShow">
      <div class="left">
        <div class="scoreRate">
          <span>语法平均答对率</span>
          <span class="rate"
            ><span class="number">{{ (info.GrammarScoreRate * 100).toFixed(2) }}</span
            >%</span
          >
        </div>
      </div>
      ...
      <div class="dialogContent">
        <div class="dialogMain">
          <el-table :empty-text="emptyText" :data="tableData" style="width: 450px">
            ...
            <el-table-column prop="GramMasterCount" label="语法掌握量" width="140">
              <template slot-scope="scope">
                <span class="gray">
            ...
            <el-table-column prop="GramScoreRate" label="语法答对率">
              <template slot-scope="scope">
                <span class="gray"> {{ (scope.row.GramScoreRate * 100).toFixed(2) }}% </span>
              </template>
            </el-table-column>
            <template slot="empty">
...
<script>
import { GetClassGrammer, GetClassGrammerList } from "@/api/paperTwo/question.js";
import "echarts-gl";
export default {
  data() {
    return {
