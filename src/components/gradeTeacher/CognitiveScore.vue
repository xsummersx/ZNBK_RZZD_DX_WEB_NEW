...
<template>
  <div class="left-Content-Box">
    ...
    <el-dialog :title="TitleDis" :visible.sync="dialogDis" :close-on-click-modal="false" width="440px" top="0vh">
      <div class="DisContent">
        <ScoreDis></ScoreDis>
      </div>
    </el-dialog>
    <el-dialog :title="TitleTrend" :visible.sync="dialogTrend" :close-on-click-modal="false" width="440px" top="0vh">
      <div class="DisContent">
...
<script>
import { GetClassCognitiveIndex, GetGradeCognitiveIndex } from "@/api/gradeTeacher/left.js";
